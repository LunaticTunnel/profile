...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://sksnsnsnj.zvx.my.id:81/izin/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://sksnsnsnj.zvx.my.id:81/izin/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://sksnsnsnj.zvx.my.id:81/izin/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
restart_system() {
    USRSC=$(wget -qO- https://sksnsnsnj.zvx.my.id:81/izin/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://sksnsnsnj.zvx.my.id:81/izin/ip | grep $ipsaya | awk '{print $3}')
...
function menu(){
    ...
    wget https://sksnsnsnj.zvx.my.id:81/limit/menu.zip
